...
class NewPostFormTest(TestCase):
    ...
    def setUp(self):
        ...
        self.mock_photo = SimpleUploadedFile(
            name='test_image.jpg',
            content=open(
                '/Users/johan/Dev-courses/Django-course/platzigram/fixtures/imgs/profile/img_test.001.png',
                'rb'
                ).read(),
    ...
    def test_form_normal(self):
        ...
        file_mock = open('/Users/johan/Dev-courses/Django-course/platzigram/fixtures/imgs/profile/img_test.001.png', 'rb')
